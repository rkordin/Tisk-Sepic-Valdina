        ...
        <div className="row">
          <div className="col-12">
            <div className="td-cta-big-title-wrap pb-125">
              <h2 className="td-cta-big-title">Tisk Šepic.</h2>
            </div>
          </div>
        </div>
        <div className="row">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6">
                <div className="td-cta-para">
                  <p>Zadovoljnih strank nam zaupa že več kot 40 let.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="row align-items-center">
                ...
                <div className="td-cta-count-wrap">
                  ...
                  <div className="td-cta-count">
                    <h3 className="td-cta-count-title">
                      ...
                      <span className="td-cta-count-title-pre">let</span>
                    </h3>
                  </div>
                </div>
              </div>
              <div className="col-xl-6">
                <div className="td-cta-para">
                  <p>
                    Znanje pridobljeno v več kot 40 letih v tiskarski industriji.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="row align-items-center">
                ...
                <div className="td-cta-count-wrap">
                  ...
                  <div className="td-cta-count">
                    <h3 className="td-cta-count-title">
                      ...
                      <span className="td-cta-count-title-pre">m²</span>
                    </h3>
                  </div>
                </div>
              </div>
              <div className="col-xl-6">
                <div className="td-cta-para">
                  <p>Proizvodnih prostorov z najsodobnejšo opremo.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="row align-items-center">
                ...
                <div className="td-cta-count-wrap">
                  ...
                  <div className="td-cta-count">
                    <h3 className="td-cta-count-title">
                      ...
                      <span className="td-cta-count-title-pre">zaposlenih</span>
                    </h3>
                  </div>
                </div>
              </div>
              <div className="col-xl-6">
                <div className="td-cta-para">
                  <p>Strokovna ekipa, predana kakovosti in inovacijam.</p>
                </div>
              </div>
            </div>
          </div>
