...
export const TeamThree = () => {
  return (
    <div className="td-team-area pb-120">
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="td-team-5-border pt-140 mt-30">
              <div className="row">
                <div className="col-12">
                  <div
                    className="td-team-5-title-wrap mb-75 text-center wow fadeInUp"
                    data-wow-delay=".3s"
              ...
              <div className="row">
                <div className="col-12">
                  <div
                    className="td-team-5-bottom-border pt-30 mt-35 wow fadeInUp"
                    data-wow-delay=".7s"
                    data-wow-duration="1s"
                  >
